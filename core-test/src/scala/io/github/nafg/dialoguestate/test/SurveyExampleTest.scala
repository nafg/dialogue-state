  ...
  override def spec: Spec[TestEnvironment, Any] = suite("Survey Test")(
    test("can complete survey with high satisfaction rating") {
      for {
        ...
        _      <- tester.expect("Great! Let's get started", "On a scale of 1 to 5")
        _      <- tester.sendDigits("5")
        _      <- tester.expect(
                    "We're glad to hear that you rated us 5 out of 5",
                    "What aspect of our product did you like the most"
                  )
        _      <- tester.sendDigits("1")
        _      <- tester.expect(
                    "We're glad you appreciated the quality",
                    "On a scale of 0 to 10, how likely are you to recommend"
                  )
        _      <- tester.sendDigits("10")
        _      <- tester.expect("Thank you for being a promoter", "Would you be willing to provide a testimonial")
        _      <- tester.sendDigits("1")
        _      <- tester.expect("Please record your testimonial")
        _      <- tester.sendRecording(url"https://example.com/recordings/testimonial/123")
        _      <- tester.expect("Thank you for your testimonial", "Would you like to provide any additional comments")
    ...
    test("can complete survey with low satisfaction rating") {
      for {
        ...
        _      <- tester.sendDigits("2")
        _      <-
          tester.expect("We're sorry to hear that you rated us 2 out of 5", "We'd like to understand what went wrong")
        _      <- tester.sendDigits("3")
        _      <- tester.expect("We're sorry about the customer service issues", "Please tell us how we could improve")
        _      <- tester.sendRecording(url"https://example.com/recordings/improvement/456")
        _ <- tester.expect("Thank you for your suggestions", "On a scale of 0 to 10, how likely are you to recommend")
        _ <- tester.sendDigits("3")
        _ <- tester.expect("We appreciate your honest feedback", "Would you like to provide any additional comments")
        _ <- tester.sendDigits("1")
    ...
    test("can complete survey with neutral satisfaction rating") {
      for {
        ...
        _      <- tester.expect("Great! Let's get started", "On a scale of 1 to 5")
        _      <- tester.sendDigits("3")
        _      <- tester.expect("Thank you for rating us 3 out of 5", "What aspect of our product could we improve")
        _      <- tester.sendDigits("2")
        _      <- tester.expect("Thank you for your feedback", "Please tell us how we could improve")
        _      <- tester.sendRecording(url"https://example.com/recordings/neutral/123")
        _ <- tester.expect("Thank you for your suggestions", "On a scale of 0 to 10, how likely are you to recommend")
        _ <- tester.sendDigits("7")
        _ <- tester.expect("Thank you for your feedback", "Would you like to provide any additional comments")
        _ <- tester.sendDigits("2")
        _ <- tester.expect("Thank you for completing our customer satisfaction survey")
      } yield assertCompletes
    }
